...
import com.ccarlos.service.search.HouseBucketDTO;
...
public class HouseController {
    ...
    public String show(@PathVariable(value = "id") Long houseId,
        ...
        Map<SupportAddress.Level, SupportAddressDTO>
                addressMap = addressService.findCityAndRegion
                (houseDTO.getCityEnName(), houseDTO.getRegionEnName());
        ...
        ServiceResult<Long> aggResult = searchService.aggregateDistrictHouse
                (city.getEnName(), region.getEnName(), houseDTO.getDistrict());
    ...
    public String rentMapPage(@RequestParam(value = "cityEnName") String cityEnName,
        ...
        ServiceMultiResult<SupportAddressDTO> regions
                = addressService.findAllRegionsByCityName(cityEnName);


        ServiceMultiResult<HouseBucketDTO> serviceResult
                = searchService.mapAggregate(cityEnName);
